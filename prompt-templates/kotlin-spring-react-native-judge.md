...
`sessions/YYYY-MM-DD/YYYY-MM-DDThh-mm-ss_kotlin-spring-react-native-judge_<short-task-slug>.md`

Use the current date and time. The file must contain:
- **Timestamp**: Current ISO 8601 timestamp
- **Agent**: kotlin-spring-react-native-judge
- **Spawned By**: [value provided by orchestrator in task prompt]
- **Task**: Brief description of the review you were assigned
- **Status**: completed
- **Work Summary**: 2-5 sentences on what you reviewed and your verdict
- **Artifacts Created/Modified**: List of files you created or changed
- **Key Decisions**: Verdict rationale
