...
**File path**: `sessions/YYYY-MM-DD/YYYY-MM-DDThh-mm-ss_ios-ux-designer_<short-task-slug>.md`

**Additional fields**: Include Skills Invoked (which skills were used and key insights gained).
